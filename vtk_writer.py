...
def write_vtu(Verts, Cells, pdata=None, pvdata=None, cdata=None, cvdata=None,
    ...
    for i in range(0, n_pdata):
        ...
        d = {'type': 'Float32', 'Name': 'pdata %d' % (
            i), 'NumberOfComponents': '1', 'format': 'ascii'}
    ...
    for i in range(0, n_pvdata):
        ...
        d = {'type': 'Float32', 'Name': 'pvdata %d' % (
            i), 'NumberOfComponents': '3', 'format': 'ascii'}
